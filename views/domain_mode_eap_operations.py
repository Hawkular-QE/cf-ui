...
class domain_mode_eap_operations():
    ...
    def find_domain_mode_eap_power(self):
    ...
    def stop_eap(self):
        self.find_domain_mode_eap_power()
    ...
    def kill_eap(self):
        ...
        self.start_eap()   #Start EAP to perform other operation Tests
        return True
    ...
    def start_eap(self):
        ...
        ui_utils(self.web_session).accept_alert(20)
        assert ui_utils(self.web_session).waitForTextOnPage("Start initiated for selected server(s)", 20)
        return True
